@extends('layouts.app', ['activePage' => 'kabupaten', 'titlePage' => __('Tambah Data')])
@section('content')
<div class="content">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
        <form method="post" action="{{ route('kabupaten.store') }}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
          @csrf
          @method('post')
          <div class="card ">
            <div class="card-header bg-dark">
              <h4 class="card-title text-white" >{{ __('Tambah Kabupaten') }}</h4>
              <p class="card-category"></p>
            </div>
            <div class="card-body ">
              <div class="row">
                <div class="col-md-12 text-right">
                  <a href="{{ route('kabupaten.index') }}" class="btn btn-sm btn-warning">{{ __('Back to list') }}</a>
                </div>
              </div>
