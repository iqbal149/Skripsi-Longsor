@extends('layouts.app', ['activePage' => 'kabupaten', 'titlePage' => __('Data Kabupaten')])
@section('content')
    <div class="content">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg-dark">
                            <h4 class="card-title text-white">{{ __('Data Kabupaten') }}</h4>
                            <p class="card-category"> {{ __('Menampilkan data kabupaten') }}</p>
                        </div>
                        <div class="card-body">
                            @if ($data->count())
                                <div class="row">
                                                    ...
                                                    @foreach ($data as $key => $value)
                                                        <tr>
                                                            ...
                                                            <td class="td-actions text-center">
                                                                <form
                                                                    action="{{ route('kabupaten.destroy', $value->uuid) }}"
                                                                    method="post">
                                                                    @csrf
                                                                    @method('delete')
                                                                    ...
                                                                    <a rel="tooltip" class="btn btn-md btn-success"
                                                                        href="{{ route('kabupaten.edit', $value->uuid) }}"
                                                                        data-original-title="" title="">
