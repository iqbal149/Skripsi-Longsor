@extends('layouts.app', ['activePage' => 'kecamatan', 'titlePage' => __('Edit Data Kabupaten')])
...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="{{ route('kabupaten.kecamatan.update', [$kabupaten->uuid, $kecamatan->uuid]) }}" autocomplete="off"
                        ...
                        <div class="card ">
                            <div class="card-header bg-dark">
                                <h4 class="card-title text-white">{{ __('Edit Kecamatan') }}</h4>
                                <p class="card-category"></p>
                            </div>
                            <div class="card-body ">
                                <div class="row">
                                    <div class="col-md-12 text-right">
                                        <a href="{{ route('kabupaten.kecamatan.index', $kabupaten->uuid) }}"
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group{{ $errors->has('kode') ? ' has-danger' : '' }}">
                                                <input
                                                    ...
                                                    value="{{ old('kode', $kecamatan->kode) }}" required="true"
                                                    aria-required="true" />
                                                @if ($errors->has('kode'))
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group{{ $errors->has('label') ? ' has-danger' : '' }}">
                                                <input
                                                    ...
                                                    placeholder="{{ __('Nama Kecamatan') }}"
                                                    value="{{ old('label', $kecamatan->label) }}" required="true"
                                                    aria-required="true" />
                                                @if ($errors->has('label'))
                                                    <span id="label-error" class="error text-danger"
